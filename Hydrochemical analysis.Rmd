...
Multivariate normality Q-Q plots and distribution of data trasformed: according to Shapiro-Wilk test, it can't assume multinormality in all cases (untransformed and transformed data). The p-value is greater than 0.05, hence the distribution of the given data is different from normal distribution significantly.
...
```{r Kruskal-Wallis test, echo = FALSE}
...
```{r pca.winter.complet, echo = FALSE}
...
```{r PCA.Plots, echo = FALSE, fig.width = 12, fig.height = 12}
